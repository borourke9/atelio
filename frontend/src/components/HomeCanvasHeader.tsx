      ...
      <div className="relative max-w-7xl mx-auto px-8 py-20">
        <div className="text-center">
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-8 animate-fade-in">
            ...
            <span className="text-white/90 font-medium text-sm tracking-wide uppercase">AI-Powered Design Tool</span>
          </div>
          ...
          <p className="text-lg text-white/60 max-w-2xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
